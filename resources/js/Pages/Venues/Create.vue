        ...
        <div class="page-wrap">
            ...
            <div class="page-header">
                <div>
                    ...
                    <div class="page-eyebrow"><span class="eyebrow-dot"></span>New Venue</div>
                    <h1 class="page-title">Add New Venue</h1>
                    <p class="page-sub">Fill in the details below to create a new venue</p>
                </div>
                <Link :href="route('venues.index')" class="btn-ghost">
            ...
            <div v-if="showValidationSummary && Object.keys(clientErrors).length > 0" class="error-banner">
                ...
                <div>
                    <div class="error-banner-title">Please fix the following errors before submitting:</div>
            ...
            <form @submit.prevent="submit" novalidate class="form-layout">
                ...
                <div class="sidebar-col">
                    ...
                    <div class="ep-card sidebar-sticky">
                        <div class="card-head">
                            <span class="card-icon" style="background:rgba(192,23,15,.08)">📊</span>
                            <div><div class="card-title">Venue Summary</div></div>
                        </div>
                        ...
                        <!-- CTA -->
                        <div style="padding:14px 16px;border-top:1px solid #E8E2DA">
                            ...
                            <Link :href="route('venues.index')" class="btn-ghost w-full" style="justify-content:center;margin-top:8px">
                                Cancel
                            </Link>
                        </div>
                    </div>
...
const form = useForm({
    ...
    capacity_min: '', capacity_max: '', area_sqft: '',
    base_price_per_day: '', base_price_per_hour: '', security_deposit: '',
    amenities: [],
    virtual_tour_url: '', terms_and_conditions: '', cancellation_policy: '',
